...
Вне зависимости от количества уровней O(n) — т.к. уровней всегда меньше, чем n (иначе в них нет смысла). В общем случае рассматриваются 2–3 уровня, хранящие половину значений предыдущего уровня — получаем n+1/2n+1/4n+1/8n+... ≈ n+n ≈ n
## Реализация
